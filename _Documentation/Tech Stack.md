...
- [Electron](https://www.electronjs.org/): Full stack desktop application framework
	- [Node.js](http://nodejs.org/en) (Backend Framework): JavaScript runtime environment
	...
	- [Howler.js](https://www.npmjs.com/package/howler) (Frontend Library): Audio Handler.
	- [Cheerio](https://www.npmjs.com/package/cheerio) (Library): JavaScript Parser for HTML and XML.
	- [React Fast Marquee](https://www.npmjs.com/package/react-fast-marquee) (Frontend Component): Text Marquee
